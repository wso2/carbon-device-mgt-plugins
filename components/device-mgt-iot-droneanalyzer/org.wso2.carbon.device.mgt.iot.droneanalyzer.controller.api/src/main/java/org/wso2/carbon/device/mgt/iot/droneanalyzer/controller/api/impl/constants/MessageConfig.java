...
package org.wso2.carbon.device.mgt.iot.droneanalyzer.controller.api.impl.constants;
...
public class MessageConfig {
    ...
    public static final  String OUTBOUND_MESSAGE_FORMAT_FOR_IRISDRONE = "{\"quatanium_val\":[%f, %f, %f]," +
            "\"basicParam\":{\"velocity\":[%f, %f, %f], \"global_location\":[%f, %f, %f]},\"battery_level\":%f," +
            "\"device_type\":\"IRIS_DRONE\"}";
    public static final  String OUTBOUND_MESSAGE_FORMAT_FOR_SIMULATOR = "{\"quatanium_val\":[%f, %f, %f, %f]," +
            "\"basicParam\":{\"velocity\":[%f, %f, %f], \"global_location\":[%f, %f, %f]},\"battery_level\":%f, " +
