...
package org.wso2.carbon.device.mgt.mobile.windows.impl.dao.util;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.device.mgt.mobile.windows.exception.WindowsDeviceMgtPluginException;
import org.wso2.carbon.device.mgt.mobile.windows.impl.config.datasource.JNDILookupDefinition;
import org.wso2.carbon.device.mgt.mobile.windows.impl.config.datasource.MobileDataSourceConfig;
import org.wso2.carbon.device.mgt.mobile.windows.impl.util.MobileDeviceManagementSchemaInitializer;
...
public class MobileDeviceManagementDAOUtil {
     ...
     */
    public static void setupMobileDeviceManagementSchema(DataSource dataSource, String
            pluginType) throws WindowsDeviceMgtPluginException {
        ...
        try {
            ...
            throw new WindowsDeviceMgtPluginException("Error occurred while initializing Mobile Device " +
