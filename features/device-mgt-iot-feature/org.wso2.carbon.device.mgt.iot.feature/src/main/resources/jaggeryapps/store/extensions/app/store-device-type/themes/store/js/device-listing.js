...
function attachDeviceEvents() {
    ...
    $("a.edit-device-link").click(function () {
        ...
        var editDeviceAPI = "/store/apis/devices/" + deviceType + "/" + deviceId + "/update";
    ...
    if ($("a.group-device-link").length > 0) {
        $("a.group-device-link").click(function () {
            var deviceId = $(this).data("deviceid");
            var deviceType = $(this).data("devicetype");
            var endPoint = "/store/apis/group/all";
                ...
                function (data, txtStatus, jqxhr) {
                    ...
                    if (status == 200) {
                        ...
                        $("a#group-device-yes-link").click(function () {
                            ...
                            endPoint = "/store/apis/group/id/" + selectedGroupId + "/assign";
...
function attachGroupEvents() {
    ...
    $("a.share-group-link").click(function () {
        ...
        invokerUtil.get("/store/apis/users",
            function (data, txtStatus, jqxhr) {
                ...
                if (status == 200) {
                    ...
                    $("a#share-group-next-link").click(function () {
                        ...
                        invokerUtil.get("/store/apis/group/id/" + groupId + "/" + selectedUser + "/rolemapping",
                            function (data, txtStatus, jqxhr) {
                                ...
                                if (status == 200) {
                                    ...
                                    $("a#share-group-yes-link").click(function () {
                                        ...
                                        invokerUtil.post("/store/apis/group/id/" + groupId + "/" + selectedUser + "/roleupdate",
                                            updatedRoleMap,
                                            function (data, txtStatus, jqxhr) {
                                                var status = jqxhr.status;
                                                if (status == 200) {
    ...
    $("a.remove-group-link").click(function () {
        var groupId = $(this).data("groupid");
        var removeGroupApi = "/store/apis/group/id/" + groupId + "/remove";
    ...
    $("a.edit-group-link").click(function () {
        ...
        var editGroupApi = "/store/apis/group/id/" + groupId + "/update";
