...
#sudo rm -rf wso2-raspi-agent*
#dpkg --remove --force-remove-reinstreq wso2-raspi-agent
...
#for f in ./wso2-raspi-agent_1.0.0_all.deb; do
#    ## Check if the glob gets expanded to existing files.
#    ## If not, f here will be exactly the pattern above
#    ## and the exists test will evaluate to false.
#    # [ -e "$f" ] && echo "'wso2-raspi-agent_1.0.0_all.deb' file found and installing" || echo "'wso2-raspi-agent_1.0.0_all.deb' file does not exist in current path"; exit;
#    if [ -e "$f" ]; then
#    	echo "'wso2-raspi-agent_1.0.0_all.deb' file found and installing now...."
#    else
#    	echo "'wso2-raspi-agent_1.0.0_all.deb' file does not exist in current path. \nExiting installation...";
#    	exit;
#    fi
...
#echo "Installing the 'wso2-raspi-agent_1.0.0 deb package'"
#sudo gdebi wso2-raspi-agent_1.0.0_all.deb
...
#sudo nohup ./src/RaspberryStats.py -i $input > /dev/null 2>&1 &
