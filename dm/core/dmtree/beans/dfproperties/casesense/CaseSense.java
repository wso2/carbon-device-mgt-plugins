...
public class CaseSense {
    ...
    @XmlElements({
            ...
            @XmlElement(name = "CIS", required = true, type = CIS.class)
    })

    private AbstractCaseSenseProperty caseSense;

    public AbstractCaseSenseProperty getCaseSense() {
        return caseSense;
    }

    public void setCaseSense(AbstractCaseSenseProperty caseSense) {
